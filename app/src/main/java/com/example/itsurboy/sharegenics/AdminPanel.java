...
public class AdminPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog dialog = new SpotsDialog(AdminPanel.this,R.style.welcome);

        mAuth = FirebaseAuth.getInstance();
        memail = (EditText)findViewById(R.id.emailet);
        mpassword = (EditText)findViewById(R.id.passwordet);
        mloginbtn = (Button)findViewById(R.id.loginbtn);
        ll = (LinearLayout)findViewById(R.id.activity_admin_panel);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(firebaseAuth.getCurrentUser() != null){
                    startActivity(new Intent(AdminPanel.this,DataBase.class));
                }
            }
        };
    ...
    public void sign (View view){
        ...
        startActivity(new Intent(AdminPanel.this,Signup.class));
    }
